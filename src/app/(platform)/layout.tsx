...
// Platform shell (UI_BUILD_PLAN §4.4). Same skeleton as the org shell, made
// deliberately distinct (dark sidebar + "Platform plane" badge) so operators
// always know which plane they're on. Scope enforcement stays server-side.
