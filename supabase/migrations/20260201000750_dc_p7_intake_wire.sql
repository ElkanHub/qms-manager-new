-- ============================================================================
-- DC Phase 7 (wiring) — connect the unified intake to the change pipe. Dispatching
-- a CHANGE_SINGLE/CHANGE_MULTI intake now opens the change control automatically
-- (NEW_SOP still creates the draft; RETIRE is wired in Phase 8).
-- ============================================================================
